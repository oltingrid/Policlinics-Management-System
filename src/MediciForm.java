...
public class MediciForm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MediciForm window = new MediciForm(8,5);
	 ...
	 */
	public MediciForm(long userId,int accessCode) {
	    ...
	    comboBoxMedicGradLoad();
	    comboBoxMedicTitluLoad();
	    comboBoxPostDidacticLoad();
	...
	private JTextField textFieldCodParafa;
	...
	private void initialize() {
		...
		frmUtilizatori.setTitle("Medici");
		...
		JLabel lblNewLabel = new JLabel("Medici");
		...
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1 = new JLabel("Medic:");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1.setBounds(494, 221, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1);
		
		textFieldCodParafa = new JTextField();
		textFieldCodParafa.setColumns(10);
		textFieldCodParafa.setBounds(599, 274, 100, 20);
		panel.add(textFieldCodParafa);
		
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1 = new JLabel("Grad");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1.setBounds(494, 249, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1);
		
		JComboBox<ItemCombo> comboBoxMedicGrad = new JComboBox<ItemCombo>();
		comboBoxMedicGrad.setBounds(599, 245, 166, 22);
		panel.add(comboBoxMedicGrad);
		cmbMedicGrad = comboBoxMedicGrad;
		
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1 = new JLabel("Parafa cod:");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1.setBounds(494, 277, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1);
		
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2 = new JLabel("Titlu:");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2.setBounds(494, 312, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2);
		
		JComboBox<ItemCombo> comboBoxMedicTitlu = new JComboBox<ItemCombo>();
		comboBoxMedicTitlu.setBounds(599, 308, 166, 22);
		panel.add(comboBoxMedicTitlu);
		cmbMedicTitlu = comboBoxMedicTitlu;
		
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2_1 = new JLabel("Post didactic:");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2_1.setBounds(494, 340, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_2_1);
		
		JComboBox<ItemCombo> comboBoxPostDidactic = new JComboBox<ItemCombo>();
		comboBoxPostDidactic.setBounds(599, 341, 166, 22);
		panel.add(comboBoxPostDidactic);
		cmbPostDidactic = comboBoxPostDidactic;
		...
		JLabel lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1_1 = new JLabel("Comision (%):");
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1_1.setBounds(491, 378, 107, 17);
		panel.add(lblNewLabel_1_2_1_1_1_1_1_1_1_1_1_1_1_1_1);
		
		textFieldComision = new JTextField();
		textFieldComision.setColumns(10);
		textFieldComision.setBounds(599, 374, 100, 20);
	 ...
	 public void table_load()
	 {
		 ...
		 try {
				...
				// formate the SQL
				String sqlText = "SELECT * FROM utilizatori_angajati_medici_view";
				
				
				if(this.loginUserAccessCode==1) {
					//individual access onky 
					Long id = this.loginUserTd;
					sqlText = "SELECT * FROM utilizatori_angajati_medici_view WHERE id_utilizator="+id.toString(); 
				} else {
	...
	private void cmdloadSelectdRecord(String selectedID) {
		 try {
				...
				// formate the SQL
				String sqlText = "SELECT * FROM utilizatori_angajati_medici_view WHERE id_utilizator="+selectedID;
		 		...
		 		if(rset.next()==true) {
					...
					// comboBoxMedicGrad
			 		cmbMedicGrad.setSelectedIndex(0);//valoare implicita
			 		for(int i=0;i<cmbMedicGrad.getItemCount();i++) {
				 		ItemCombo fa = (ItemCombo) cmbMedicGrad.getItemAt(i);
				 		if(fa.getId()==rset.getLong("id_medic_grad")) {
				 			cmbMedicGrad.setSelectedIndex(i);
				 			break;
				 		}
			 		}
					//textFieldCodParafa
			 		textFieldCodParafa.setText(rset.getString("cod_parafa"));
			 		
					//comboBoxMedicTitlu
			 		cmbMedicTitlu.setSelectedIndex(0);//valoare implicita
			 		for(int i=0;i<cmbMedicTitlu.getItemCount();i++) {
				 		ItemCombo fa = (ItemCombo) cmbMedicTitlu.getItemAt(i);
				 		if(fa.getId()==rset.getLong("id_titlu_stiintific")) {
				 			cmbMedicTitlu.setSelectedIndex(i);
				 			break;
				 		}
			 		}			 		
			 		
					//comboBoxPostDidactic
			 		cmbPostDidactic.setSelectedIndex(0);//valoare implicita
			 		for(int i=0;i<cmbPostDidactic.getItemCount();i++) {
				 		ItemCombo fa = (ItemCombo) cmbPostDidactic.getItemAt(i);
				 		if(fa.getId()==rset.getLong("id_postul_didactic")) {
				 			cmbPostDidactic.setSelectedIndex(i);
				 			break;
				 		}
			 		}	
			 		textFieldComision.setText(rset.getString("comision"));
			 		
			 		// determinam daca utilizatorul selectat este deja adaugat ca medic: 
			 		Long idUtilizatorAngjat = rset.getLong("id_medic");
			 		...
			 		textDataAngajare.setText("");
			 		textParola.setText("");
			 		textFieldCodParafa.setText("");
			 		textFieldComision.setText("");
			 		
			 		
			 		
			 		cmbMedicGrad.setSelectedIndex(0);
			 		cmbMedicTitlu.setSelectedIndex(0);
			 		cmbPostDidactic.setSelectedIndex(0);
	...
	private void cmdSave() {
	 ...
	 private void cmdSaveUpdate(){
			try {
				...
				String UPDATE = "UPDATE  medici SET id_medic_grad=?,cod_parafa=?,id_titlu_stiintific=?,id_postul_didactic=?,comision=? WHERE id_utilizator=?";
				
				PreparedStatement pstmt = con.prepareStatement(UPDATE, PreparedStatement.RETURN_GENERATED_KEYS);

				
				ItemCombo mg = (ItemCombo)cmbMedicGrad.getSelectedItem();	
				pstmt.setLong(1,mg.getId());
				
				pstmt.setString(2,textFieldCodParafa.getText());
				
				ItemCombo ts = (ItemCombo)cmbMedicTitlu.getSelectedItem();	
				pstmt.setLong(3,ts.getId());

				ItemCombo pd = (ItemCombo)cmbPostDidactic.getSelectedItem();	
				pstmt.setLong(4,pd.getId());
				
				pstmt.setString(5,textFieldComision.getText());
	 ...
	 private void cmdSaveNew(){
			try {
				...
				String INSERT = "INSERT INTO medici (id_utilizator,id_medic_grad,cod_parafa,id_titlu_stiintific,id_postul_didactic,comision) VALUES (?,?,?,?,?,?)";
				...
				pstmt.setString(3,textFieldCodParafa.getText());
				
				
				ItemCombo ts = (ItemCombo)cmbMedicTitlu.getSelectedItem();	
				pstmt.setLong(4,ts.getId());

				ItemCombo pd = (ItemCombo)cmbPostDidactic.getSelectedItem();	
				pstmt.setLong(5,pd.getId());
				
				pstmt.setString(6,textFieldComision.getText());	
	 ...
	 private void clearFields() {
		 ...
		 textFieldComision.setText("");
	 		...
	 		if(cmbMedicGrad!=null && cmbMedicGrad.getItemCount()>0)
	 			cmbMedicGrad.setSelectedIndex(0);
	 		
	 		if(cmbMedicTitlu!=null && cmbMedicTitlu.getItemCount()>0)
	 			cmbDepartament.setSelectedIndex(0);

	 		
	 		if(cmbPostDidactic!=null && cmbPostDidactic.getItemCount()>0)
	 			cmbPostDidactic.setSelectedIndex(0);
	 ...
	 private void enableFields(boolean b) {
		 ...
		 textFieldCodParafa.setEnabled(b);
		 textFieldComision.setEnabled(b);
	 		
	 		if(cmbMedicGrad!=null && cmbMedicGrad.getItemCount()>0)
	 			cmbMedicGrad.setEnabled(b);
	 		
	 		if(cmbMedicTitlu!=null && cmbMedicTitlu.getItemCount()>0)
	 			cmbMedicTitlu.setEnabled(b);
	 		
	 		if(cmbPostDidactic!=null && cmbPostDidactic.getItemCount()>0)
	 			cmbPostDidactic.setEnabled(b);
	 ...
	 public void comboBoxMedicGradLoad()
	 {
		 
		 try {

				// formate the SQL
				String sqlText = "SELECT * FROM grade_medic";
		 		PreparedStatement pstmt = con.prepareStatement(sqlText);
		 		ResultSet rset = pstmt.executeQuery();
		 		while (rset.next()){
		 			//String[] record = new String[] {rset.getString("id_functie")};
		 			ItemCombo fa = new ItemCombo(rset.getLong("id_grad"),rset.getString("denumire"));
		 			cmbMedicGrad.addItem(fa);
		 		}
		 		cmbMedicGrad.setSelectedIndex(0);//valoare implicita
	 ...
	 public void comboBoxMedicTitluLoad()
	 {
		 
		 try {

				// formate the SQL
				String sqlText = "SELECT * FROM titluri_stiintifice_medic";
		 		PreparedStatement pstmt = con.prepareStatement(sqlText);
		 		ResultSet rset = pstmt.executeQuery();
		 		while (rset.next()){
		 			//String[] record = new String[] {rset.getString("id_functie")};
		 			ItemCombo fa = new ItemCombo(rset.getLong("id_titlu"),rset.getString("denumire"));
		 			cmbMedicTitlu.addItem(fa);
		 		}
		 		cmbMedicTitlu.setSelectedIndex(0);//valoare implicita
	 ...
	 public void comboBoxPostDidacticLoad()
	 {
		 try {
				// formate the SQL
				String sqlText = "SELECT * FROM posturi_didactice_medic";
		 		PreparedStatement pstmt = con.prepareStatement(sqlText);
		 		ResultSet rset = pstmt.executeQuery();
		 		while (rset.next()){
		 			//String[] record = new String[] {rset.getString("id_functie")};
		 			ItemCombo fa = new ItemCombo(rset.getLong("id_post_didactic"),rset.getString("denumire"));
		 			cmbPostDidactic.addItem(fa);
		 		}
		 		cmbPostDidactic.setSelectedIndex(0);//valoare implicita
		 		pstmt.close();
			} catch (SQLException e) {
